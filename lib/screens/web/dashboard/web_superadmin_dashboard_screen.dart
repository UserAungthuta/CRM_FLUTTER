  ...
  Future<void> _fetchQuickStats() async {
    ...
    try {
      ...
      switch (userRole) {
        ...
        case 'member':
        case 'champion':
          url = '${ApiConfig.baseUrl}/quickstats/enigneer';
          break;
        case 'localcustomer':
        case 'globalcustomer':
          url = '${ApiConfig.baseUrl}/quickstats/customer';
          break;
        default:
          _showSnackBar(context, 'Unsupported user role: $userRole',
              color: Colors.red);
      }
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 10),
                                      if (userRole == 'localcustomer' ||
                                          userRole == 'globalcustomer')
                                        ElevatedButton(
                                          onPressed: () {
                                            Navigator.of(context)
                                                .pushNamed('/reports');
