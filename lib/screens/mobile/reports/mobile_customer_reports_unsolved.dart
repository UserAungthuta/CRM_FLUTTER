...
class MobileCustomerUnSolvedReportScreen extends StatefulWidget {
  const MobileCustomerUnSolvedReportScreen({super.key});

  @override
  _MobileCustomerUnSolvedReportScreenState createState() =>
      _MobileCustomerUnSolvedReportScreenState();
}

class _MobileCustomerUnSolvedReportScreenState
    extends State<MobileCustomerUnSolvedReportScreen> {
