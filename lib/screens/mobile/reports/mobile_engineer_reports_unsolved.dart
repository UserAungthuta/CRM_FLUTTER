...
import 'report_solve_screen.dart'; // Import the new solve screen
...
class MobileEngineerUnSolvedReportScreen extends StatefulWidget {
  const MobileEngineerUnSolvedReportScreen({super.key});

  @override
  _MobileEngineerUnSolvedReportScreenState createState() =>
      _MobileEngineerUnSolvedReportScreenState();
}

class _MobileEngineerUnSolvedReportScreenState
    extends State<MobileEngineerUnSolvedReportScreen> {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    bool showSolveButton =
                        report['status'] == 'solving'; // Logic for Solve button
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (showPickupButton) ...[
                                ...
                                ElevatedButton(
                                  onPressed: () => _pickupReport(report['id']!),
                              ...
                              if (showSolveButton) ...[
                                // Display Solve button if status is 'solving'
                                const SizedBox(height: 10),
                                ElevatedButton(
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => ReportSolveScreen(
                                            reportId: report['id']!),
                                      ),
                                    );
                                  },
