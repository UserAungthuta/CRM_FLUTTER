...
class MobileEngineerSolvedReportScreen extends StatefulWidget {
  const MobileEngineerSolvedReportScreen({super.key});

  @override
  _MobileEngineerSolvedReportScreenState createState() =>
      _MobileEngineerSolvedReportScreenState();
}

class _MobileEngineerSolvedReportScreenState
    extends State<MobileEngineerSolvedReportScreen> {
