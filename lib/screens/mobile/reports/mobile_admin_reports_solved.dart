...
class MobileAdminSolvedReportScreen extends StatefulWidget {
  const MobileAdminSolvedReportScreen({super.key});

  @override
  _MobileAdminSolvedReportScreenState createState() =>
      _MobileAdminSolvedReportScreenState();
}

class _MobileAdminSolvedReportScreenState
    extends State<MobileAdminSolvedReportScreen> {
